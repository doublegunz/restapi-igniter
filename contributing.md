# Contributing to restapi-igniter
...
* Please **do not** use the issue tracker for personal support requests.  Please [email me](mailto:gungunpriatna02@gmail.com) as they are better places to get help.
...
1. [Fork](https://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git remote add upstream https://github.com/doublegunz/restapi-igniter
   ```
